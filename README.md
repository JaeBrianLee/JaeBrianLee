...
- **VantaSoft** — Hands-on engineering across Amira Learning, Telvana, and CardSync.
- **Amira Learning** — Enterprise assessment, reporting, access-control, privacy, multilingual, and AWS data-platform work.
- **Telvana** — Reliable AI voice agents, native tool calling, scheduling integrations, and operational reporting.
- **CardSync** — Inventory, scanning, pricing, payments, claim sales, and operator workflows for trading-card businesses.
- **Blink Labs / TosiDrop** — Cardano products, wallet and rewards flows, analytics, multi-network support, and edge infrastructure.
- **Zusty** — Open-source Zustand debugging through a Chrome DevTools extension and npm middleware.
- **Ordo** — A privacy-conscious social iOS product built with SwiftUI and Supabase.

## Core stack

`TypeScript` · `React` · `Next.js` · `Node.js` · `Python` · `AWS` · `PostgreSQL` · `GraphQL` · `Cloudflare Workers` · `Supabase` · `Stripe Connect` · `SwiftUI`
